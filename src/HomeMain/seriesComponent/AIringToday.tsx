...
const handlegetSeries  = () => {
    return  Axios.get("https://api.themoviedb.org/3/tv/airing_today?language=en-US&page=1", {
        headers: {
    ...
    return (
        ...
        >
            ...
            <Typography sx={
              ...
              }} variant="body1" color='white'>{!data ? "" : 'Airing Today'}  </Typography>
              <Box
              sx={{
                display: "flex", 
                  position: "sticky", 
              ...
              >
              <Typography color='white' variant="h5"> {!data ? "" : 'Airing Today'}  </Typography>
              </Box>
